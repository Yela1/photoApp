package com.appsdevelopingblog.photoapp.api.users.ui.security;

import com.appsdevelopingblog.photoapp.api.users.ui.domain.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            LoginRequestModel credits = new ObjectMapper().readValue(request.getInputStream(), LoginRequestModel.class);
